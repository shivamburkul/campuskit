    ...
    <div>
      ...
      <div className="mt-6">
        <ResultPanel>
          ...
          {Math.round(totalWeight) !== 100 && <InlineNote tone="warning">Weights add up to {roundTo(totalWeight, 2)}%, not 100% — the result may not reflect your actual grading scheme.</InlineNote>}
        </ResultPanel>
      </div>
    </div>
  );

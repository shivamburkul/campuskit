...
export function Button({ variant = 'primary', className = '', ...rest }: ButtonProps) {
  ...
  const variants: Record<string, string> = {
    ...
    secondary:
      'bg-ink-100/80 text-ink-900 hover:bg-ink-200/80 dark:bg-ink-700 dark:text-ink-300 dark:hover:bg-ink-600',
    ghost:
      'text-ink-700 hover:bg-ink-100/60 dark:text-ink-300 dark:hover:bg-ink-700/60',
  };

    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <input
          ...
          type="number"
          inputMode="decimal"
          className="numeric-input no-spinner w-full rounded-xl border border-ink-200/70 bg-surface px-4 py-3 text-ink-900 shadow-sm outline-none transition-all duration-200 focus:border-primary-400 focus:ring-2 focus:ring-primary-400/30 dark:border-ink-700 dark:bg-ink-900 dark:text-ink-50 dark:focus:border-primary-500 dark:focus:ring-primary-500/30"
          {...rest}
        />
        {suffix && (
